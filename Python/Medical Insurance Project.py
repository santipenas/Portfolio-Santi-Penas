...
insurance_cost = insurance_cost = 250 * age - 128 * sex + 370 * bmi + 425 * num_of_children + 24000 * smoker - 12500
print(f"This person's {insurance_cost} is {insurance_cost} dollars.")
